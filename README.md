...
早期部分技能（如 read / write / learn / health 的分层与流程）在设计上曾参考开源项目 **[Waza](https://github.com/tw93/Waza)**（MIT）：感谢 [tw93](https://github.com/tw93) 与社区把工程习惯整理成可复用的 skill 形态。本仓库各 `SKILL.md`、`references/` 与 `scripts/` 均为独立维护与改写，**鸣谢不代表与上游行为或路径一一对应**；若你希望并列使用上游安装包，请直接参阅 Waza 仓库说明。
